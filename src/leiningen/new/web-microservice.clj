...
(defn web-microservice
  ...
  (let [main-ns (multi-segment (sanitize-ns name))
    ...
    (->files data
             ...
             ["src/{{sanitized}}/web/core.clj" (render "web__core.clj" data)]
             ["src/{{sanitized}}/web/routes.clj" (render "web__routes.clj" data)]
             ["test/{{sanitized}}/web/core.clj" (render "test__core.clj" data)]
